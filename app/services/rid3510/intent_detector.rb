  ...
  class IntentDetector
    ...
    class << self
      ...
      def detect_fallback(text)
        ...
        return "社區服務與綠色奇蹟" if text.include?("綠色奇蹟") || text.include?("再生電腦") || text.include?("數位平權") || (text.include?("偏鄉") && (text.include?("電腦") || text.include?("數位"))) || text.include?("捐電腦") || text.include?("受贈電腦") || text.include?("環保再生") || text.include?("reuse") || text.include?("扶輪之子")
